...
class BudgetTracker:
    ...
    def __init__(
        ...
        self._hourly_entries: deque[tuple[float, float]] = deque()  # (timestamp, cost)
    ...
    def check_budget(self, session_id: str, tool_name: str) -> tuple[bool, str]:
        ...
        with self._lock:
            ...
            if self._config.max_per_hour > 0:
                now = monotonic()
                cutoff = now - 3600
                while self._hourly_entries and self._hourly_entries[0][0] <= cutoff:
    ...
    def check_and_record(self, session_id: str, tool_name: str) -> tuple[bool, str]:
        ...
        with self._lock:
            ...
            self._hourly_entries.append((now, cost))
