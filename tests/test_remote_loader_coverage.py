...
class TestRemoteLoaderFetchOnce:
    ...
    def test_fetch_success(self):
        ...
        loader = RemoteRuleLoader(url="https://example.com/rules.yaml")
        mock_resp = MagicMock()
    ...
    def test_signature_verification_pass(self):
        ...
        loader = RemoteRuleLoader(url="https://example.com/rules.yaml", signature_key=key)
        mock_resp = MagicMock()
        mock_resp.status_code = 200
        mock_resp.content = content
    ...
    def test_signature_verification_fail(self):
        ...
        loader = RemoteRuleLoader(url="https://example.com/rules.yaml", signature_key="secret")
        mock_resp = MagicMock()
        mock_resp.status_code = 200
        mock_resp.content = VALID_YAML.encode("utf-8")
...
class TestRemoteLoaderStartStop:
    ...
    def test_start_and_stop(self):
        loader = RemoteRuleLoader(url="https://example.com/rules.yaml", refresh_interval=0.05)
